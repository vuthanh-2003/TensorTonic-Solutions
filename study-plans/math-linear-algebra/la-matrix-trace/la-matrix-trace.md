## <span style="font-size: 20px;">What Is the Trace?</span>
...
You can cycle the matrices, but not arbitrarily reorder them.
...
**Diagonal matrix:** $\text{tr}(D) = \sum_i D_{ii}$ (just sum the diagonal)

**Symmetric matrix:** Same as any matrix (trace of its diagonal)

**Projection matrix:** For an orthogonal projection matrix $P$, $\text{tr}(P)$ equals the rank of $P$ (dimension of the subspace being projected onto).
